...
def set_rules_db(chat_id, chat_rules):
    rule_data = rules.find_one({"chat_id": chat_id})
...
def set_private_rule(chat_id, private_note):
    ...
    if rule_data is None:
        ...
        rules.update_one({"chat_id": chat_id}, {"$set": {"private_note": private_note}})
...
def set_rule_button(chat_id, rule_button):
    ...
    if rule_data is None:
        ...
        rules.update_one({"chat_id": chat_id}, {"$set": {"button_text": rule_button}})
