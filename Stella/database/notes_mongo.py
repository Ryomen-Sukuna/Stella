...
def SaveNote(chat_id, note_name, content, text, data_type):
    GetNotes = notes.find_one({"chat_id": chat_id})
...
def GetNote(chat_id, note_name):
    GetNoteData = notes.find_one({"chat_id": chat_id})
...
def ClearNote(chat_id, note_name):
    notes.update({"chat_id": chat_id}, {"$pull": {"notes": {"note_name": note_name}}})
...
def ClearAllNotes(chat_id):
    notes.update({"chat_id": chat_id}, {"$unset": {"notes": []}})
