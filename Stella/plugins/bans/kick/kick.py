...
from Stella.helper.chat_status import can_restrict_member, isBotCan, isUserAdmin
...
async def kick(client, message):
    ...
    if user_id == BOT_ID:
        await message.reply("NOt gonna kick myself. Thanks.")
        return
    ...
    await StellaCli.kick_chat_member(
        ...
        user_id,
        int(time.time())
        + 60,  # wait 60 seconds in case of server goes down at unbanning time
    )
